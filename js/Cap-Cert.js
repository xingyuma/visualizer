...
//        var tb = document.getElementById("resultarea");
 
        var n = document.getElementById('resultarea').childNodes.length;
        for ( var i = 0; i < n; i++) {
            document.getElementById('resultarea').removeChild(
            document.getElementById('resultarea').firstChild);
        }
        ...
        for (var i = 0; i < this.chain.length; i++) {
            ...
            cont.id = "result"+i;
            cont.className = "well well-small";
